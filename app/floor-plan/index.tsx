...
const S = StyleSheet.create({
  ...
  deviceListCard:    { borderRadius: 20, overflow: 'hidden', backgroundColor: '#0f1e3a', borderWidth: 1, borderColor: 'rgba(255,255,255,0.16)', shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.5, shadowRadius: 20, elevation: 16 },
  deviceListBlur:    { borderRadius: 20, overflow: 'hidden' },
